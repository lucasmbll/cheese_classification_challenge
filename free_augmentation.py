...
def generate_augmented(path):
    ...
    data_augmentor = DataAugmentation(data_dir=path, aggressive_augmentations=False)
    data_augmentor.augment_images()


if __name__ == "__main__":
    path = r"C:\Users\adib4\OneDrive\Documents\Travail\X\MODAL DL\cheese_classification_challenge\dataset\toaugment"
